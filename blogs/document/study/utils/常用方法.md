...
;(async () => {
    console.log(123123,'19283129873');
    await this.initPage("service");  //await里面必须返回promise对象
    console.log('zhixinganansdsu');
})()
```
